...
inputkg = input/1000;
topsg = topstrain/1000;
botsg = bottomstrain/1000;
figure;
plot(MStimes, inputkg, 'LineWidth', 1.0);
fontsize = 11;
...
figure;
plot(MStimes, outputkg, 'LineWidth', 1.0);
fontsize = 11;
fonttype = 'Times New Roman';
figurepos = [1 1];
figuresize = [6.5 1.5];
...
figure;
plot(MStimes, topsg, 'LineWidth', 1.0);
fontsize = 11;
fonttype = 'Times New Roman';
figurepos = [1 1];
figuresize = [6.5 1.5];
...
figure;
plot(MStimes, botsg, 'LineWidth', 1.0);
fontsize = 11;
fonttype = 'Times New Roman';
figurepos = [1 1];
figuresize = [6.5 1.5];
